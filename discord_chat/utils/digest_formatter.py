...
def create_digest_header(
    ...
    Args:
        ...
        channel_filter: Optional channel name if filtering to single channel.
    ...
    # Show channel filter in title if specified
    channel_scope = f" (#{channel_filter})" if channel_filter else ""

    return f"""# Discord Digest: {data.server_name}{channel_scope}
...
def create_full_digest(
    ...
    """
    header = create_digest_header(data, llm_name, channel_filter)
